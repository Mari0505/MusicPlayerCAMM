...
public class Controller {
    ...
    @FXML
    private TableColumn<Song, String> lyricsColumn;
   // @FXML
   // private TableColumn<Song, Boolean> favoriteColumn;
  // @FXML
   ...
   */
   ...
   @FXML
    ...
    private void initialize() throws Exception {
        ...
        artistNameColumn.setCellValueFactory(cellData -> cellData.getValue().artistProperty());
        albumColumn.setCellValueFactory(cellData -> cellData.getValue().albumProperty());
        yearColumn.setCellValueFactory(cellData -> cellData.getValue().yearProperty());
        lyricsColumn.setCellValueFactory(cellData -> cellData.getValue().formatProperty());
            ...
            if(file.isFile()) {
                ...
                if(name.endsWith("mp3") || name.endsWith("wav")) {
                    try {
                        ...
                        Song song = new Song (String.valueOf(i),tag.getTitle(),tag.getGenreDescription(), tag.getArtist(),
                                tag.getAlbum(), tag.getYear(), tag.getLyrics(), file.getAbsolutePath());
